...
def test_blob(sky_, radius, rms_factor=1, filename=None):
    ...
    sky_.find_blob(radius=radius, blob_size=5, type_='difference', rms_factor=rms_factor)
...
# test_vote('../data/cf_set_6_mock_1.fits')
# test_vote('../data/cf_set_6_mock_2.fits')
# test_vote('../data/cf_set_6_mock_3.fits')
# test_vote('../data/cf_set_6_mock_4.fits')
scan_radius('../models/cf_set_6_mock_1')
scan_radius('../models/cf_set_6_mock_2')
scan_radius('../models/cf_set_6_mock_3')
scan_radius('../models/cf_set_6_mock_4')
